...
use crate::types::series::KSeries;
...
thread_local! {
    ...
    static TYPE_SERIES: KString = "Series".into();
...
impl From<KSeries> for KValue {
    fn from(value: KSeries) -> Self {
        Self::Series(value)
    }
}
